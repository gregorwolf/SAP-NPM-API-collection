...
This package contains the OData VDM for the [Warehouse Inbound Delivery Service](https://api.sap.com/api/API_WHSE_INBOUND_DELIVERY) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Warehousing - Inbound Delivery Integration (SAP_COM_0385).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/a8/29826d35714642999d7b7dfbd58b8f/frameset.htm).
