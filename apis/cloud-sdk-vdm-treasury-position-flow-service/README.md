...
This package contains the OData VDM for the [Treasury Position Flow Service](https://api.sap.com/api/A_TRSYPOSFLOW_CDS) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Finance - Treasury Position Flow Integration (SAP_COM_0332).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/fd/bdf48471784561a68d2a23d474650d/frameset.htm).
