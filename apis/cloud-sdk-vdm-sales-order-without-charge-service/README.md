...
This package contains the OData VDM for the [Sales Order Without Charge Service](https://api.sap.com/api/API_SALES_ORDER_WITHOUT_CHARGE_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Sales Order Without Charge Integration (SAP_COM_0334).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/1e/b3e97d4e314e769d614b8d5b16468d/frameset.htm).
