...
This package contains the OData VDM for the [Characteristic Attribute Catalog Service](https://api.sap.com/api/API_CHARCATTRIBUTECATALOG_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Inspection Master Data Integration (SAP_COM_0110).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/2002.500/EN/92/9751669aeb40f083215bf16c284c1a/frameset.htm).
