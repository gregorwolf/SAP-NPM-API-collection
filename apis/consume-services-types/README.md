[![Build Status](https://gkeplatform2.jaas-gcp.cloud.sap.corp/buildStatus/icon?job=consume-services-types-ci%2Fmaster)](https://gkeplatform2.jaas-gcp.cloud.sap.corp/job/consume-services-types-ci/job/master/)
