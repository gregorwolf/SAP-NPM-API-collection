...
This package contains the OData VDM for the Defect Category Service of SAP S/4HANA Cloud.

## Usage Example
```
import { defectCategoryService } from '@sap/cloud-sdk-vdm-defect-category-service';
