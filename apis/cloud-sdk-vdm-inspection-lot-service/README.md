...
This package contains the OData VDM for the [Inspection Lot Service](https://api.sap.com/api/API_INSPECTIONLOT_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Quality Inspection Process Integration (SAP_COM_0318).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/61/ff4c3780864ce1b0822d9c5e6cd3bb/frameset.htm).
