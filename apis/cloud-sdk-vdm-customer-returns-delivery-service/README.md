...
This package contains the OData VDM for the Customer Returns Delivery Service of SAP S/4HANA Cloud.

## Usage Example
```
import { customerReturnsDeliveryService } from '@sap/cloud-sdk-vdm-customer-returns-delivery-service';
