...
- Fixed an issue where the application requirements in the Project Accelerator were cleared if the user navigated away and then back to the Project Accelerator
- Fixed an issue where the app generation process continued running even after being stopped at step 7

## [1.18.4] - 2025-07-24
### Project Accelerator
- Fixed an issue where the project generated by the Project Accelerator was not available if a folder or workspace was not already open
