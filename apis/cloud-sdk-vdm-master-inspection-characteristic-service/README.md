...
This package contains the OData VDM for the [Master Inspection Characteristic Service](https://api.sap.com/api/API_MASTERINSPCHARACTERISTIC_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Inspection Master Data Integration (SAP_COM_0110).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/71/644958b4ae9144e10000000a4450e5/frameset.htm).
