...
This package contains the OData VDM for the Payment Advice Service of SAP S/4HANA Cloud.

## Usage Example
```
import { paymentAdviceService } from '@sap/cloud-sdk-vdm-payment-advice-service';
