...
This package contains the OData VDM for the [Commercial Project Service](https://api.sap.com/api/SC_PROJ_ENGMT_CREATE_UPD_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Commercial Project Integration (SAP_COM_0054).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/2002.500/EN/8a/6dc4ab5f854c92863a2f8a248b061b/frameset.htm).
