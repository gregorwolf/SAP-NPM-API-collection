...
This package contains the OData VDM for the [Purchasing Pricing Condition Type Service](https://api.sap.com/api/API_PURGPRICINGCONDITIONTYPE_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Pricing Data Integration (SAP_COM_0294).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/3e/ef869ce7a749dbb35607c065368179/frameset.htm).
