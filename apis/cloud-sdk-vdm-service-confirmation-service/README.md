...
This package contains the OData VDM for the [Service Confirmation Service](https://api.sap.com/api/API_SERVICE_CONFIRMATION_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Service Confirmation Integration (SAP_COM_0352).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/a4/6bcadb5c914c06ae8b84c9a6dc368f/frameset.htm).
