...
This package contains the OData VDM for the [Personnel Settlement Document Service](https://api.sap.com/api/API_PERS_SETTLMT_DOC) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Logistics - Employee Central Personnel Settlement Document Integration (SAP_COM_0469).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/f1/96aa7b945547b99f58896ee3d3f8d4/frameset.htm).
