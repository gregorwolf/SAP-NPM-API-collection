...
This package contains the OData VDM for the Reservation Document Service of SAP S/4HANA Cloud.

## Usage Example
```
import { reservationDocumentService } from '@sap/cloud-sdk-vdm-reservation-document-service';
