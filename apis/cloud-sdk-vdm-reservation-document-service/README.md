...
This package contains the OData VDM for the [Reservation Document Service](https://api.sap.com/api/API_RESERVATION_DOCUMENT_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Reservation Integration (SAP_COM_0112).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/51/86af9bebab426984f5c399a5b2664b/frameset.htm).
