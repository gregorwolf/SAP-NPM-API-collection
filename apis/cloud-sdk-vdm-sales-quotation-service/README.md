...
This package contains the OData VDM for the [Sales Quotation Service](https://api.sap.com/api/API_SALES_QUOTATION_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Sales Quotation Integration (SAP_COM_0118).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/2002.500/EN/bc/fea10daf7241aea335dab3bc70ea8e/frameset.htm).
