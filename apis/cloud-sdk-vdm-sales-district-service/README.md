...
This package contains the OData VDM for the [Sales District Service](https://api.sap.com/api/API_SALESDISTRICT_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: SAP Analytics Cloud for Planning Integration (SAP_COM_0087).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/ae/06955b5a0d4005a65680bb4ca61553/frameset.htm).
