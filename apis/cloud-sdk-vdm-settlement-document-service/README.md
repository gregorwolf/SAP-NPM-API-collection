...
This package contains the OData VDM for the Settlement Document Service of SAP S/4HANA Cloud.

## Usage Example
```
import { settlementDocumentService } from '@sap/cloud-sdk-vdm-settlement-document-service';
