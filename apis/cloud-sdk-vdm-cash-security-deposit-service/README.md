...
This package contains the OData VDM for the Cash Security Deposit Service of SAP S/4HANA Cloud.

## Usage Example
```
import { cashSecurityDepositService } from '@sap/cloud-sdk-vdm-cash-security-deposit-service';
