...
This package contains the OData VDM for the [Supplier Invoice Process Service](https://api.sap.com/api/API_SUPPLIERINVOICE_PROCESS_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Supplier Invoice Integration (SAP_COM_0057).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/7b/c52558ef790a02e10000000a44147b/frameset.htm).
