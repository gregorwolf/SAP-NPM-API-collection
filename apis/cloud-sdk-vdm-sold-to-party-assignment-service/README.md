...
This package contains the OData VDM for the [Sold To Party Assignment Service](https://api.sap.com/api/API_SD_SA_SOLDTOPARTYDETN) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Sold-to Party Assignment of Sales Scheduling Agreement Integration (SAP_COM_0367).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/19/e224a14b034a4798e08bddafd2fe78/frameset.htm).
