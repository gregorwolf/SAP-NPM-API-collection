...
This package contains the OData VDM for the [Outbound Delivery Service](https://api.sap.com/api/API_OUTBOUND_DELIVERY_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Delivery Processing Integration (SAP_COM_0106).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/b1/b123d381bb4ad6b9cbaafaaa87aa24/frameset.htm).
