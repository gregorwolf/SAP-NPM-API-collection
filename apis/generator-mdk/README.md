# MDK Generator
This CLI tool allows developers to generate Mobile Development Kit (MDK) projects independently of the MDK development support already available in [SAP Business Application Studio](https://help.sap.com/doc/f53c64b93e5140918d676b927a3cd65b/Cloud/en-US/docs-en/guides/getting-started/mdk/bas.html) and [Visual Studio Code](https://help.sap.com/doc/f53c64b93e5140918d676b927a3cd65b/Cloud/en-US/docs-en/guides/getting-started/mdk/vscode/create-mdk-metadata-object-with-vscode-editor.html).
...
### Installation
- Install [Yeoman](http://yeoman.io) and generator-mdk using [npm](https://www.npmjs.com/):

  ```bash
  npm install -g yo@4.3.0
  npm install -g @sap/mdk-tools
  npm install -g @sap/generator-mdk
  ```
- Generate your new SAP Mobile Development Kit (MDK) project:
...
yo @sap/mdk --dataFile ./test/debugData/mdkdemoprojectMin.json --tool 'mdktoolsPath'
```
>Use `dataFile` option if pass the JSON object in code.
...
>The `edmxPath` can be OData `.xml` file path or file content. The `path` is relative to the configuration file.
