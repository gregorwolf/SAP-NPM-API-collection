...
This package contains the OData VDM for the Supplier Quotation Service of SAP S/4HANA Cloud.

## Usage Example
```
import { supplierQuotationService } from '@sap/cloud-sdk-vdm-supplier-quotation-service';
