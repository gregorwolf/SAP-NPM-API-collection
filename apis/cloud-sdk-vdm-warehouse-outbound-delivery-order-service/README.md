...
This package contains the OData VDM for the [Warehouse Outbound Delivery Order Service](https://api.sap.com/api/API_WHSE_OUTB_DLV_ORDER) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Warehousing - Process Outbound Delivery Order Integration (SAP_COM_0356).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/33/1cfb1d12c148569cd94072a421c69f/frameset.htm).
