...
This package contains the OData VDM for the [Process Order Confirmation Service](https://api.sap.com/api/API_PROC_ORDER_CONFIRMATION) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Production Planning Integration (SAP_COM_0104).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/46/c0325825a0a107e10000000a441470/frameset.htm).
