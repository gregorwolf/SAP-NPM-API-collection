...
This package contains the OData VDM for the Defect Class Service of SAP S/4HANA Cloud.

## Usage Example
```
import { defectClassService } from '@sap/cloud-sdk-vdm-defect-class-service';
