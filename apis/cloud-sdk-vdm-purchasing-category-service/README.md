...
This package contains the OData VDM for the [Purchasing Category Service](https://api.sap.com/api/API_PURCHASING_CATEGORY_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Purchasing Category Integration (SAP_COM_0123).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/6f/c0e604c28749af90ee61d86e58d7c6/frameset.htm).
