...
This package contains the OData VDM for the Packing Instruction Service of SAP S/4HANA Cloud.

## Usage Example
```
import { packingInstructionService } from '@sap/cloud-sdk-vdm-packing-instruction-service';
