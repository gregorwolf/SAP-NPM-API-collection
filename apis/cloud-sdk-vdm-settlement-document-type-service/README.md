...
This package contains the OData VDM for the Settlement Document Type Service of SAP S/4HANA Cloud.

## Usage Example
```
import { settlementDocumentTypeService } from '@sap/cloud-sdk-vdm-settlement-document-type-service';
