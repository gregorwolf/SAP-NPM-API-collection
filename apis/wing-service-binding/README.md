[![Build Status](https://gkexmlvalidator.jaas-gcp.cloud.sap.corp/buildStatus/icon?job=wing_service_binding_CI%2Fmaster)](https://gkexmlvalidator.jaas-gcp.cloud.sap.corp/job/wing_service_binding_CI/job/master/)
