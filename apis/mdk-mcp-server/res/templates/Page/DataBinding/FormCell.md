	...
	"ActionBar": {
		"Items": [
			...
			},
			{
				"Caption": "Create",
				"Position": "Right",
				"OnPress": "/MDKSampleApp/Actions/POHeaderCreateEntity.action"
			}
		]
	},
					...
					"Controls": [
						{
							...
							"Value": "/MDKSampleApp/Rules/GeneratePurchaseOrderId.js",
							"IsEditable": false,
							"IsVisible": true,
...
```json
{
	...
	"OnSuccess": "/MDKSampleApp/Actions/POCreateSuccess.action",
	"OnFailure": "/MDKSampleApp/Actions/POCreateFailed.action",
