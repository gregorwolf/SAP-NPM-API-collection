...
This package contains the OData VDM for the [Buffer Sizing Service](https://api.sap.com/api/API_BUFFERSIZING_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: Buffer Sizing Integration (SAP_COM_0359).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/2002.500/EN/61/9f71272fd044d1958f2a08474086a0/frameset.htm).
