...
This package contains the OData VDM for the Buffer Sizing Service of SAP S/4HANA Cloud.

## Usage Example
```
import { bufferSizingService } from '@sap/cloud-sdk-vdm-buffer-sizing-service';
