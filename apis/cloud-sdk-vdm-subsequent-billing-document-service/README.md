...
This package contains the OData VDM for the [Subsequent Billing Document Service](https://api.sap.com/api/API_SUBSQNT_BILLG_DOC_SBI_SRV) of SAP S/4HANA Cloud.
This service is part of the following communication scenarios: SAP Self-Billing Cockpit Integration (SAP_COM_0564).
You can find additional documentation for this service on [help.sap.com](https://help.sap.com:00443/http.svc/ahp2/SAP_S4HANA_CLOUD/latest/EN/b9/f5d563bc2745df9c21f1c1c6a43cdd/frameset.htm).
